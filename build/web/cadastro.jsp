                ...
                <div class="container">
                    ...
                    <form class="form-horizontal" name="Formulario" action="gravaDB.jsp">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input class="form-control" type="text" name="nome" placeholder="Digite o Nome Completo"/><br>   
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input class="form-control" type="text" name="usuario" placeholder="Digite o Usuário"/><br>  
                            </div>
                        </div>
                        ...
                        <div class="col-sm-offset-2 col-sm-10">
                            ...
                            <a href="listaClientes.jsp"><h3>Clientes Cadastrados</h3></a>
