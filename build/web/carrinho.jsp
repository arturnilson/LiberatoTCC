            ...
            <div class="container"> <!-- Container -->
                <div class="section-title">
                    ...
                    <%
                        ...
                        //Obtem valor de dados da sessão
                        String lista = (String) session.getAttribute("listaCompras");

                        if (lista == null) {
                            out.println("<h2>O carrinho de compras está vazio!</h2>");
                        } else {
                            String ids[];
                    ...
                    <table border = \"2\" >
                        ...
                        <tbody>
                            <%      for (int i = 0; i < ids.length; i++) {
                                    resultados = statement.executeQuery("SELECT * FROM fotos where id_foto=" + ids[i]);
                                    while (resultados.next()) {%>
                            <tr>
                                <td><%=resultados.getString("nome_foto")%></td>
                                <td>R$15,00</td>
                            </tr>
                            <%
                                        }
                    ...
                    <br>
                    <a href=areaCliente.jsp><input type="button" value="<< Voltar a Compra"></a>&nbsp;
                    <a href=finalizaCompra.jsp><input type="button" value="Finalizar Compra"></a>
                </div>
            </div>
        </div>
    </body>
