            ...
            <div class="container"> 
                ...
                <div>
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="listaClientes.jsp" class="page-scroll">Lista de Usuários</a></li>
                    ...
                    <div class="nav navbar-nav navbar-right" id="navcli">
                        <div class="navbar-header">
                            <h4>Área do Administrador &nbsp&nbsp</h4>
                        </div>
                        <div class="navbar-header">
                            <a href="logout.jsp" class="page-scroll"><h5>Logout</h5></a>   
                        </div>
                    </div>
                </div>
