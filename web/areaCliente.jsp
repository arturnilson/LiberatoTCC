...
<head>
    ...
    <%
            ...
            // Etapa 2: Obter o valor de dados da sess�o
            ...
            <div class="section-title">
                ...
                <table align="center">
                    <tr>
                        ...
                        <td>
                            <h3 align="center"><b>Nome do Arquivo:</b> <%=imagem%></h3><img src="imagens/<%=imagem%>"
                                align="center" width="550px" class="img-responsive">
                            <h4 align="center">Adicionar ao Carrinho &nbsp<a
                                    href="adicionaCarrinho.jsp?id_foto=<%=resultados.getInt("id_foto")%>&nome_foto=<%=imagem%>"><img
                                        src="imagens/carrinhodecompras.png"></a></h4>
                        </td>
                    </tr>
